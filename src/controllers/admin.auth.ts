...
import { IAccessTokenAdmin, AccessTokenAdmin, IRefreshTokenAdmin, RefreshTokenAdmin } from "../utils/token"
...
const LoginAdmin = async (req: Request, res: Response) => {
    try {
        ...
        const dataRefreshToken: IRefreshTokenAdmin = { name: searchAdmin.name }
...
const LogoutAdmin = async (req: Request, res: Response) => {
    try {
        ...
        await TokenAdminSchema.deleteOne({ token: refreshToken })
